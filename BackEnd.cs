...
namespace simple_live_wpf
{
    class BackEnd
    {
        ...
        public void Abort()
        {
            try
            {
                Debug.WriteLine($"--- [{Thread.CurrentThread.ManagedThreadId}: BackEnd] ABORT, ABORT");
            ...
            {
                Debug.WriteLine("--- [BackEnd] Error: Failed to abort acquisition");
        ...
        public void Kill()
        {
            ...
            {
                Debug.WriteLine("--- [BackEnd] Error: Failed to kill acquisition");
